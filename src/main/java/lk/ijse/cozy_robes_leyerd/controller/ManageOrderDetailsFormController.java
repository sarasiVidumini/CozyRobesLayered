...
public class ManageOrderDetailsFormController implements Initializable {

    public AnchorPane ancORDetailsPage;

//    private final static OrderDetailsModel orderDetailModel = new OrderDetailsModel();

    private OrderDetailsBO orderDetailsBO = (OrderDetailsBO) BOFactory.getInstance().getBO(BOFactory.BOTypes.ORDERDETAILS);
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            cmbProductPlatform.setItems(FXCollections.observableArrayList(orderDetailsBO.getAllOrderIds()));
        } catch (Exception e) {
            e.printStackTrace();
        ...
        try{
            cmbOrderId.setItems(FXCollections.observableArrayList(orderDetailsBO.getAllOrderIds()));
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void btnDeleteOnAction(ActionEvent actionEvent) {
        ...
        if (result.isPresent() && result.get() == ButtonType.YES) {
            ...
            try {
                boolean isDeleted = orderDetailsBO.delete(orderDetailId);
                if (isDeleted) {
    ...
    public void btnUpdateOnAction(ActionEvent actionEvent) {
        ...
        try {
            boolean isUpdated = orderDetailsBO.update(new OrderDetailsDTO(orderDetailId, orderId, productId, quantity, priceAtPurchase));
            if (isUpdated) {
    ...
    public void btnSaveOnAction(ActionEvent actionEvent) {
        ...
        try {
            boolean isSaved = orderDetailsBO.save(new OrderDetailsDTO(orderDetailId, orderId, productId, quantity, priceAtPurchase));
            if (isSaved) {
    ...
    public void search(KeyEvent keyEvent) {
        ...
        if (search.isEmpty()) {
            ...
            try {
                ArrayList<OrderDetailsDTO> orderDetailsList = orderDetailsBO.search(search);
                tblORDetails.setItems(FXCollections.observableArrayList(
