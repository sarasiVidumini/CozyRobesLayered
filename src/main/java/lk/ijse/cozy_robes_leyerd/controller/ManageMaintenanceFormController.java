...
public class ManageMaintenanceFormController implements Initializable {
    public AnchorPane ancMaintenancePage;
//    private final MaintenanceModel maintenanceModel = new MaintenanceModel();

//    private final MaintenanceDAOImpl maintenanceDAO = new MaintenanceDAOImpl();

    private MaintenanceBO maintenanceBO = (MaintenanceBO) BOFactory.getInstance().getBO(BOFactory.BOTypes.MAINTENANCE);
    ...
    private void loadNextId() throws SQLException {
        String nextId = maintenanceBO.getNextId();
    ...
    public void btnDeleteOnAction(ActionEvent actionEvent) {
        ...
        if (result.isPresent() && result.get() == ButtonType.YES) {
            ...
            try {
                boolean isDeleted = maintenanceBO.delete(maintenanceId);
                if (isDeleted) {
    ...
    public void search(KeyEvent keyEvent) {
        ...
        if (search.isEmpty()) {
            ...
            try {
                ArrayList<MaintenanceDTO> maintenanceList = maintenanceBO.search(search);
                tblMaintenance.setItems(FXCollections.observableArrayList(
