...
//    private OrdersDAOImpl ordersDAO = new OrdersDAOImpl();
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            cmbCustomerPlatform.setItems(FXCollections.observableArrayList(ordersBO.getAllCustomerIds()));
        ...
        try {
            cmbProductPlatform.setItems(FXCollections.observableArrayList(ordersBO.getAllProductIds()));
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void loadNextId() throws Exception {
        String nextId = ordersBO.getNextId();
    ...
    public void btnUpdateOnAction(ActionEvent actionEvent) {
        ...
        try {
            boolean isUpdated = ordersBO.update(new OrdersDTO(orderId, customerId, orderDate, status, productId));
            if (isUpdated) {
    ...
    public void btnSaveOnAction(ActionEvent actionEvent) {
        ...
        try {
            boolean isSaved = ordersBO.save(new OrdersDTO(orderId, customerId, orderDate, status, productId));
            if (isSaved) {
    ...
    public void search(KeyEvent keyEvent) {
        ...
        if (search.isEmpty()) {
            ...
            try {
                ArrayList<OrdersDTO> orderList = ordersBO.search(search);
                tblOrders.setItems(FXCollections.observableArrayList(
                        orderList.stream()
                                .map(orderDto -> new OrdersTM(
                                        orderDto.getOrderId(),
